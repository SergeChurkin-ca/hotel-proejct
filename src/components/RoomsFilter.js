            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    <div className="single-extra">
                        <input type="checkbox" name="breakfast" value="breakfast" id="bteakfast" checked={breakfast} onChange={handleChange}/>
                        <label htmlFor="breakfast">breakfast</label>
                    </div>
                    <div className="single-extra">
                        <input type="checkbox" name="pets" value="pets" id="bteakfast" checked={pets} onChange={handleChange}/>
